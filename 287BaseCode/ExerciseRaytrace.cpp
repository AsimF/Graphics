...
void buildScene() {
	...
	scene.addObject(new VisibleIShape(plane, yellowRubber));
	scene.addObject(new VisibleIShape(sphere1, silver)); //make sure to comment these three out if errors with quadratic
